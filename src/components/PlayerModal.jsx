      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto relative"> {/* Div que representa o conteúdo do modal: fundo branco, cantos arredondados, largura máxima e altura limitada com scroll. */} 
        ...
        <div className="p-0"> {/* Div para agrupar o conteúdo principal do modal, sem padding inicial. */} 
          ...
          <div className="relative h-auto md:h-96 overflow-hidden chelsea-hero-section"> {/* Div para a seção de destaque, com altura responsiva e overflow oculto. */} 
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pl-20"> {/* Div que centraliza os sobrenomes, com posicionamento absoluto e padding-left para mover para a direita. */} 
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between h-full"> {/* Div container para a foto e o primeiro nome, com layout responsivo. */} 
              ...
              {/* Primeiro nome - Centralizado abaixo da foto em mobile, no meio em desktop */} {/* Comentário para indicar a seção do primeiro nome. */} 
              <div className="w-full flex justify-center items-center py-6 md:py-0 md:absolute md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 z-10 md:pl-20"> {/* Div para o primeiro nome, com posicionamento responsivo e padding-left para mover para a direita. */} 
